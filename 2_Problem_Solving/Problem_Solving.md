...
5. How should I label the important pieces of data that are a part of the
   problem?
...
2. How many inputs? How large are the numbers expected to be? Are they
   integers?...
3. Int? Float? String?
...
This forces you to think about the code you'll write before you write it, and
helps you catch any lingering conceptual issues or misunderstandings before you
dive in and have to worry about details (e.g. language syntax) as well.
...
of a subset of data in an array/string etc.
